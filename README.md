...
- **Current release line:** **0.7.1** (see `CHANGELOG.md`).
...
- **Git tags:** use `v0.7.1` (or current `__version__`) for releases. An older **`v0.2.0`** tag may exist as a snapshot — details in [docs/VERSIONING.md](docs/VERSIONING.md).
